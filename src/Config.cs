namespace NRaft
{
    ...
    public class Config
    {
        ...
        private bool deleteOldFiles = DELETE_OLD_FILES;

        /**
         * The directory where we will read and write raft data files
         */
        private string logDir = "raft";
         ...
         */
        public Config setDeleteOldFiles(bool deleteOldFiles)
        {
